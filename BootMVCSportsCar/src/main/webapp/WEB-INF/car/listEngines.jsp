		...
		<div class="header">
			...
			<div class="navigation">
				<nav class="nav nav-tabs">
					...
					<a class="nav-item nav-link active" href="listEngines.do" method="GET">List All Engines </a>
				</nav>
			</div>
		</div>
		<c:forEach items="${engine }" var="engineVar">
		<div class="container">
			<h4>${engineVar.name}</h4>
			<h5>Database Id: ${engineVar.id }</h5>
			<h5>Specifications:</h5>
			<p>
			<div>
				<ul>
					<li>Displacement: ${engineVar.displacement}</li>
					<li>Cylinders: ${engineVar.cylinders }</li>
					<li>Configuration: ${engineVar.configuration }</li>
